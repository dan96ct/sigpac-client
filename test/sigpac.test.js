...
describe("Suite de pruebas Sigpac", () => {
  ...
  it("Deberia devolver un objeto con informacion de una parcela", (done) => {
    const data = {
      provincia: 2,
      agregado: 0,
      zona: 0,
  ...
  it("Deberia devolver un objeto con informacion de un recinto", (done) => {
    const data = {
      provincia: 2,
      agregado: 0,
      zona: 0,
  ...
  it("Deberia devolver un objeto con informacion de una linea de declaración", (done) => {
    const data = {
      lng: -1.8054282,
      lat: 38.9598049,
    };
