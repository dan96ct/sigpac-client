...
const transformCoords = (geojson, projection) => {
     geojson.features.map( (feature) => {
          for (let key in feature.geometry.coordinates[0]) {
               ...
               let secondProjection = proj4.default.defs(projection);
               feature.geometry.coordinates[0][key] = proj4.default(firstProjection, secondProjection, feature.geometry.coordinates[0][key]);
          }
          return feature;
     });
     return geojson;
